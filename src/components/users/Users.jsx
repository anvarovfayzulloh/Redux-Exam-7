...
import { useGetUsersQuery, useGetUsersv2Query, useDeleteUserMutation } from '../../redux/api/userApi';
import { Button, notification } from 'antd';
import { AiOutlineLoading } from 'react-icons/ai';

const Users = () => {
    const { data, isLoading: usersIsLoading } = useGetUsersQuery();
    const { data: datav2, isLoading: usersv2IsLoading } = useGetUsersv2Query();
